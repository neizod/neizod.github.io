...
>       <input type="radio" onchange="movetreasure()" name="treasure" value="0" />
>     </td>
>     <td>
>       <div class="emojipic" id="t1"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="1" />
>     </td>
>     <td>
>       <div class="emojipic" id="t2"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="2" />
>     </td>
>     <td>
>       <div class="emojipic" id="t3"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="3" checked />
>     </td>
>     <td>
>       <div class="emojipic" id="t4"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="4" />
>     </td>
>     <td>
>       <div class="emojipic" id="t5"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="5" />
>     </td>
>     <td>
>       <div class="emojipic" id="t6"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="6" />
>     </td>
>     <td>
>       <div class="emojipic" id="t7"></div>
>       <input type="radio" onchange="movetreasure()" name="treasure" value="7" />
>     </td>
>   </tr>
>   <tr>
>     <th>stand?</th>
...
>       <input type="checkbox" name="x0" onchange="togstand(0)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p1"></div>
>       <input type="checkbox" name="x1" onchange="togstand(1)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p2"></div>
>       <input type="checkbox" name="x2" onchange="togstand(2)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p3"></div>
>       <input type="checkbox" name="x3" onchange="togstand(3)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p4"></div>
>       <input type="checkbox" name="x4" onchange="togstand(4)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p5"></div>
>       <input type="checkbox" name="x5" onchange="togstand(5)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p6"></div>
>       <input type="checkbox" name="x6" onchange="togstand(6)" />
>     </td>
>     <td>
>       <div class="emojipic" id="p7"></div>
>       <input type="checkbox" name="x7" onchange="togstand(7)" />
>     </td>
>   </tr>
>   <tr>
>     <th>name:</th>
...
> <div class="flex">
>   <div class="magic">
>     <p><button onclick="assistant()" id="assistant">assistant</button></p>
>     <p id="ra">&nbsp;</p>
>   </div>
>   <div class="magic">
>     <p>protocol?</p>
>     <p>
>       <button id="normal" onclick="protocol(0)">normal</button>
>       <button id="reverse" onclick="protocol(-1)">reverse</button>
>     </p>
>   </div>
>   <div class="magic">
>     <p><button onclick="magician()" id="magician">magician</button></p>
>     <p id="rm">&nbsp;</p>
>   </div>
> </div>
>
...
Side note: I've seen this magic trick countless times. IIRC, the very first time was w/ my com-sci friends. Besides, TED-Ed covered this [riddle][ted riddle] two years ago, and their method is nice and all. However, I find the solution to be too magical. So, let me write yet another lengthily explanation here.
...
One way we may do when we face this kind of struggle is to relax. Both in relaxing our mind and the puzzle's constraint. What if we don't need to pin point the one who keep the treasure, for now. But we just only need to tell which side of the stage the treasure belongs to?
...
And that's it. This is the protocol to *hint* which person holding the treasure. To recap the algorithm, let's us first label the volunteers from left to right with binary number from 000 to 111. Our first goal is to find the 3-digit binary number $\underline{\ell mr}$ for the volunteer to sit/stand. The assistant need to do these steps:
...
5. Accuse that the volunteer with label $\underline{LMR}$ must possess the treasure.


## Bitwise XOR scheme

The previous protocol already answer our curiosity on how one can make the magic works. However, it is quite hard to pull off in the real magic since the protocol is a bit complicated. Luckily, there is an equivalent way to do this using [*exclusive or*][xor] (XOR, binary operation: $\oplus$) on binary number.
...
Luckily, this magic trick can be performed more than once. The easiest way is to swap the representation for sit/stand. In the previous protocol, we let stand = 1 and sit = 0. To deceive some audience who think they've arrived at the conclusion, we can flip the protocol to stand = 0 and sit = 1 instead.

And those are just the two basic ways to obscure the trick. In fact, we can choose any permutation of the labels for the volunteers. Thus, there are $8!$ ways to obfuscate the protocol.

Lastly, the trick can be adapted to work with a different number of volunteers too, as long as the number of volunteers is in form of $2^n$.
...
<script src="/scripts/hidden-treasure-magic.js"></script>
