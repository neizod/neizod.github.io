...
- [Kasetsart University][ku], class of 2023, Ph.D. in Computer Engineering.
  ...
  - Thesis: Algorithm for Counting Problems in Geometry and Combinatorics [(link)][2023thesis counting]
...
- Nonthaphat Wongwattanakij, **Nattawut Phetmak**, Chaiporn Jaikaeo, and Jittat Fakcharoenphol. An improved PTAS for covering targets with mobile sensors. *Journal of Combinatorial Optimization*, 49(2):20, 2025. [(journal)][2025journal ptas sensors] [(preprint)][2023arxiv ptas sensors]
- **Nattawut Phetmak** and Jittat Fakcharoenphol. Uniformly generating derangements with fixed number of cycles in polynomial time. *Thai Journal of Mathematics*, 21(4):899--915, Dec. 2023. [(journal)][2023journal derangements]
- **Nattawut Phetmak** and Jittat Fakcharoenphol. Folding every point on a polygon boundary to a point. *Algorithms*, 16(6):281, 2023. [(journal)][2023journal folding] [(preprint)][2023arxiv folding]

### Conference papers

- Grittin Nuntasombat, **Nattawut Phetmak**, and Jittat Fakcharoenphol. Robust bichromatic classification in 3D using planes and slices. In *22nd International Conference on Electrical Engineering/Electronics, Computer, Telecommunications and Information Technology (ECTI-CON'25)*. IEEE, 2025. [(paper)][2025conf bichromatic] [(preprint)][2026arxiv bichromatic]
- Chawin Aiemvaravutigul, Jittat Fakcharoenphol, and **Nattawut Phetmak**. Building two communication towers over a terrain. In *17th International Joint Conference on Computer Science and Software Engineering (JCSSE'20)*, pages 150--154. IEEE, 2020. [(paper)][2020conf building 2 towers]
- **Nattawut Phetmak**, Wason Liwlompaisan, and Pruet Boonma. Travel password: A secure and memorable password scheme. In *Asian Conference on Intelligent Information and Database Systems (ACIIDS'14)*, pages 402--411. Springer, 2014. [(paper)][2014conf travel password]

### Preprints

- **Nattawut Phetmak**, Grittin Nuntasombat, and Jittat Fakcharoenphol. Covering planar lattices with interior-disjoint unit disks. *arXiv preprint arXiv:2607.19764*, 2026. [(preprint)][2026arxiv covering lattices]

### Extended abstracts

- Jittat Fakcharoenphol, Grittin Nuntasombat, and **Nattawut Phetmak**. Covering planar lattices with interior-disjoint unit disks. In *28th Japan Conference on Discrete and Computational Geometry, Graphs, and Games (JCDCGGG'26)*, 2026. [(full version)][2026arxiv covering lattices]
- **Nattawut Phetmak** and Jittat Fakcharoenphol. Folding every point on a polygon boundary to a point. In *24th Japan Conference on Discrete and Computational Geometry, Graphs, and Games (JCDCGGG'22)*, pages 120--121, 2022. [(full version)][2023journal folding]
...
[ku]: //en.wikipedia.org/wiki/Kasetsart_University
[cmu]: //en.wikipedia.org/wiki/Chiang_Mai_University
[prc]: //en.wikipedia.org/wiki/Prince_Royal%27s_College


[2023thesis counting]: //www.lib.ku.ac.th/KUthesis/2566/nattawut-phe-all.pdf

[2025journal ptas sensors]: //doi.org/10.1007/s10878-024-01253-4
...
[2026arxiv covering lattices]: //arxiv.org/abs/2607.19764
[2026arxiv bichromatic]: //arxiv.org/abs/2607.19754
[2023arxiv ptas sensors]: //arxiv.org/abs/2305.03946
[2023arxiv folding]: //arxiv.org/abs/2305.01467

[2025conf bichromatic]: //ieeexplore.ieee.org/abstract/document/11100624/
